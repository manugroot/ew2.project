...
public class NewYearGift implements Totalweight {
    ...
    public static void main(String args[]){
        ...
        Gems gems=new Gems(sugarParam,weightParam);
        sugar_levels[0]=gems.getSugarLevel();
        weights[0]=gems.getWeight();
        names[0]=gems.getClass().getSimpleName();
        ...
        Kitkat kitkat=new Kitkat(sugarParam1,weightParam1);
        sugar_levels[1]=kitkat.getSugarLevel();
        weights[1]=kitkat.getWeight();
        names[1]=kitkat.getClass().getSimpleName();
        ...
        Licks licks=new Licks(sugarParam2,weightParam2);
        sugar_levels[2]=licks.getSugarLevel();
        weights[2]=licks.getWeight();
        names[2]=licks.getClass().getSimpleName();
        ...
        Pricks pricks=new Pricks(sugarParam3,weightParam3);
        sugar_levels[3]=pricks.getSugarLevel();
        weights[3]=pricks.getWeight();
        names[3]=pricks.getClass().getSimpleName();
        ...
        Rolls rolls=new Rolls(sugarParam4,weightParam4);
        sugar_levels[4]=rolls.getSugarLevel();
        weights[4]=rolls.getWeight();
        names[4]=rolls.getClass().getSimpleName();
